            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("O satélite está dividido em módulo da plataforma e módulo da carga útil. No módulo da carga útil são acoplados todos os subsistemas relacionados com a missão do satélite.\nNa plataforma do satélite temos subsistemas responsáveis pelo fornecimento de atitude e controlo orbital, controlo térmico, controlo da alimentação eléctrica, comandos e telemetria necessária para atender a demanda da carga útil.\n", style: Theme.of(context).textTheme.body1,
                       ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(" A fonte de alimentação principal do satélite provêm do Sol, que através dos painéis solares converte a luz solar em energia, tendo também as baterias como fonte de alimentação secundária, no princípio da vida útil do satélite, em fase de eclipse e em situação anômala (ONS) dos painéis solares.\n\nDurante a fase de lançamento os painéis solares são dobrados e abertos para dar início a fase de operação normal com o satélite, na fase de eclipse as duas baterias de longa duração são utilizadas como suporte ao subsistema de alimentação.\nDepois do satélite estar em funcionamento na sua posição orbital, todos os painéis solares são expostos a luz do Sol e rodam acompanhando-o através do mecanismo de rotação dos painéis solares para abastecer todos os subsistemas.\n\n", style: Theme.of(context).textTheme.body1,
                       ),
                ],
                ),
              ),
