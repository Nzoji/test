...
List<Vocabulary> vocabulary = [
  ...
  Vocabulary(word: 'Altamente elíptica, órbita', meaning: 'HEO - High eliptical orbit (sigla em inglês). É uma órbita elíptica com alta excentricidade, geralmente se referindo a uma em torno da Terra. Exemplos de órbitas HEO inclinadas incluem órbitas de Molniya.'),
  ...
  Vocabulary(word: 'Baixa, órbita', meaning: 'É tipicamente uma órbita circular a cerca de 400 a 900 quilômetros acima da superfície da Terra e, correspondentemente, tem um período muito mais curto (tempo para girar em torno da Terra) de cerca de 90 minutos.'),
  Vocabulary(word: 'Banda C', meaning: 'Ver C.'),
  Vocabulary(word: 'Banda Ka', meaning: 'Ver Ka.'),
  Vocabulary(word: 'Banda Ku', meaning: 'Ver Ku.'),
  ...
  Vocabulary(word: 'C', meaning: 'É uma faixa de frequência utilizada nas comunicações com satélites que tem as seguintes características:\n\n•1. 	Espectro de frequência segundo o IEEE: 3.9 GHz até 6.2 GHz.\n\n•2. Espectro de frequência comercial utilizado: 3.7 GHz até 6.425 GHz.\n\n• 3.	É utilizado um sinal de frequência 6 GHz para comunicação no sentido Terra→ satélite; e 4 GHz no sentido satélite→ Terra.'),
  ...
  Vocabulary(word: 'Fase', meaning: 'Fracção do disco de um planeta ou satélite iluminada pelo Sol, tal como vista da Terra.'),
  ...
  Vocabulary(word: 'Ka', meaning: 'É uma parte da parte de microondas do espectro eletromagnético definida como frequências na faixa de 26,5-40 gigahertz (GHz), ou seja, comprimentos de onda de pouco mais de um centímetro a 7,5 milímetros.'),
  ...
  Vocabulary(word: 'Média, órbita', meaning: 'É uma órbita média da Terra (MEO - sigla em inglês) É a região do espaço ao redor da Terra acima da órbita baixa da Terra e abaixo da órbita geoestacionária. O uso mais comum de satélites nesta região é para a navegação, como as constelações GPS (com uma altitude de 20.200 km), Glonass (com uma altitude de 19.100 km) e Galileu (com uma altitude de 23.222 km). Os satélites de comunicações que cobrem o Pólo Norte e Sul são também colocados na MEO..'),
  ...
  Vocabulary(word: 'Módulo da carga útil', meaning: 'Módulo ligado a um satélite comercial com circuitos de comunicação que opera independentemente da segmento espacial principal, mas que compartilha a fonte de alimentação e os transponders do satélite. '),
  Vocabulary(word: 'Módulo da plataforma', meaning: 'É um modelo no qual os satélites geralmente fornecem alocação para a carga útil (normalmente experimentos ou instrumentos espaciais).'),
  ...
  Vocabulary(word: 'ONS', meaning: 'Ver situação anômala.'),
  ...
  Vocabulary(word: 'Polar, órbita', meaning: 'É aquela em que um satélite passa acima ou quase acima de ambos os pólos do corpo sendo orbitado (geralmente um planeta como a Terra, mas possivelmente outro corpo como a Lua ou o Sol) em cada revolução. Por isso, tem uma inclinação de (ou muito perto de) 90 graus em relação ao equador do corpo. Um satélite em uma órbita polar passará sobre o equador em uma longitude diferente em cada uma de suas órbitas.'),
  Vocabulary(word: 'Polarização', meaning: 'É uma propriedade de ondas eletromagnéticas. As ondas eletromagnéticas são tridimensionais e a polarização é uma medida da orientação espacial dos vetores campo elétrico e campo magnético'),
  ...
  Vocabulary(word: 'Propulsores elétricos de plasma', meaning: 'Um motor de propulsão a plasma é um tipo de propulsão elétrica que gera empuxo a partir de um plasma quase neutro. Isso está em contraste com os motores a propulsão de íons, que geram impulso através da extração de uma corrente de íons da fonte de plasma, que é então acelerada a altas velocidades usando redes / anodos.'),
  ...
  Vocabulary(word: 'Rastreador de estrelas', meaning: 'Um rastreador de estrelas é um dispositivo óptico que mede as posições das estrelas usando fotocélulas ou uma câmera. \nComo as posições de muitas estrelas foram medidas pelos astrônomos com um alto grau de precisão, um rastreador de estrelas em um satélite ou espaçonave pode ser usado para determinar a orientação (ou atitude) de um satélite em relação às estrelas.'),
  ...
  Vocabulary(word: 'Sensor solar', meaning: 'Um sensor solar é um instrumento de navegação usado por espaçonaves para detectar a posição do sol. Os sensores solares são usados ​​para controle de atitude, posicionamento de painéis solares, atualização de giroscópios e recuperação à prova de falhas.'),
  Vocabulary(word: 'Síncrona do Sol, órbita', meaning: '(SSO - sigla em inglês, também chamada órbita heliosíncrona) é uma órbita quase polar ao redor de um planeta, na qual o satélite passa por qualquer ponto da superfície do planeta no mesmo tempo solar médio local.'),
  ...
  Vocabulary(word: 'Situações anômalas', meaning: 'Ver ONS.'),
  ...
  Vocabulary(word: 'Transferência geostacionária, órbita', meaning: 'Uma órbita elíptica usada para transferir entre duas órbitas circulares de raios diferentes no mesmo plano usada para alcançar a órbita geoestacionária ou geoestacionária usando motores químicos de alta potência.'),
  Vocabulary(word: 'Transponder', meaning: 'Aparelho emissor-receptor que responde automaticamente a uma mensagem de identificação, ao sinal de um radar; repetidor de radio-frequência.'),
